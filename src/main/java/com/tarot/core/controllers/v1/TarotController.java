...
import com.tarot.core.dto.response.tarot.ReadTarotResponseDataDTO;
...
public class TarotController {
  ...
  @GetMapping("/read")
  public ResponseEntity<CustomResponseDTO<ReadTarotResponseDataDTO>> executeTarotReading() {
    final ReadTarotResponse readTarotResponse = this.tarotService.generateTarotReading();
    final ReadTarotResponseDataDTO tarotReadingDto = ReadTarotResponseDataDTO.builder()
    ...
    final CustomResponseDTO<ReadTarotResponseDataDTO> response = CustomResponseDTO.<ReadTarotResponseDataDTO>builder()
        .message("Tarot reading has been generated successfully.")
        .data(tarotReadingDto)
        .build();
